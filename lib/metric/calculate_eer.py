...
def compute_eer(bonafide_scores: np.ndarray, other_scores: np.ndarray, return_rates: bool = False):
    """
    Returns equal error rate (EER) and the corresponding threshold.
    :param bonafide_scores: confidence scores of bonafide objects
    :param other_scores: confidence scores of spoofed objects
    """
